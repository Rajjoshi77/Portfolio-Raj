...
export default function About() {
  return (
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center px-4 py-10">
      ...
      {/* Introduction */}
      <motion.p
        className="max-w-2xl text-center text-lg md:text-xl text-slate-300 mb-12"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.p
        className="mt-16 text-slate-400 italic text-center max-w-xl"
        initial={{ y: 50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
